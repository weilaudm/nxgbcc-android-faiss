...
JNICALL
Java_io_datamachines_faiss_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */,jint number) {


    int64_t  start, end, timeData,buildTime, TrainTime, PopDbTime;
    ...
    hello <<"buildTime:"<<buildTime<<",TrainTime:"<<TrainTime<<",PopDbTime:"<<PopDbTime<<",Search Time:"<<timeData<<",Size:"<<nb;
